...
public class CrfRememberActiveFeatures<K, G> {
    ...
    /**
     * Creates an instance of {@link CrfRememberActiveFeatures} for the given
     * sentence, calls its {@link #findActiveFeaturesForAllTokens()} method, and
     * returns it. With the returned object, the method
     * {@link #getOneTokenActiveFeatures(int, Object, Object)} can be used to
     * retrieve active features for any token/tag/tag-of-previous in the
     * sentence.
     *
     * @param features
     * @param crfTags
    ...
    /**
     * Finds all the active features for every triple of
     * token/tag/tag-of-previous. Then, the method
