...
import infoextraction.InfoExtract.unstrcturedInfo.utilities.DerivableFunctionWithLastCache;
import infoextraction.InfoExtract.unstrcturedInfo.utilities.VectorUtilities;
 ...
 * <BR>
 * The BFGS algorithm approximates Newton method for optimization, by
 * approximating the inverse of the Hessian without calculating the exact
 * Hessian. The L-BFGS algorithm approximates the BFGS algorithm by
 * approximating calculations that are performed with the inverse of the
 * Hessian, but stores neither the inverse of the Hessian nor its approximation
 * in the memory. Thus the L-BFGS algorithm is much cheaper in space complexity
 * notion.
 * <BR>
 * The L-BFGS algorithm is described in the book "Numerical Optimization" by
 * Jorge Nocedal and Stephen J. Wright, Chapter 9. The book can be downloaded
 * from http://www.bioinfo.org.cn/~wangchao/maa/Numerical_Optimization.pdf
 *
 *
 *
