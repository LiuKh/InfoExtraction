...
/**
 * Encapsulates the substraction of two given points, and the substraction of
 * the gradient calculated for them (for a given function). This class is used
 * by {@link LbfgsMinimizer}.
 *
 *
